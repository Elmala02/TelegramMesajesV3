...
REPLICATION_MAP = {
    -1002148227049: [
        ...
        {"dest": -1002490959467, "name": "SR SNIPER VIP👑 Nuevo (44's Clup Nuevo)", "priority": 1, "prefix": "SR SNIPER VIP👑", "schedule": {"days": [1, 3], "start": "04:00", "end": "12:00", "timezone": "America/Bogota"}}
    ],
    -1002310215234: [
        ...
        {"dest": -1002490959467, "name": "77 Club a 44's Clup Nuevo", "priority": 2, "allow_media": True, "prefix": "🏆 77 Club", "schedule": {"days": [1, 3], "start": "04:00", "end": "12:00", "timezone": "America/Bogota"}}
    ],
    -1002108856565: [
        ...
        {"dest": -1002490959467, "name": "Sr Sniper a 44's Clup Nuevo", "priority": 3, "prefix": "🎯 Sr Sniper", "schedule": {"days": [1, 3], "start": "04:00", "end": "12:00", "timezone": "America/Bogota"}}
    ],
    -1003737486306: [
    ...
    -1002455597797: [
        {"dest": -1004438757585, "name": "Nuevo Destino", "priority": 1, "allow_media": True, "use_gemini": True}
    ],
    "@aura_capital1": [
        {"dest": -1005386250677, "name": "Aura Capital", "priority": 1, "allow_media": True, "use_gemini": True}
    ],
    -1005492244914: [
        {"dest": -1005302047567, "name": "Grupo 5492244914", "priority": 1, "allow_media": True, "use_gemini": True}
    ]
}
